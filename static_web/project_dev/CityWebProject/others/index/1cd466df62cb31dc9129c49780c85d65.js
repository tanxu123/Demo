					...
					if(!jQuery($this).hasClass("active") && isqfyscrolling==false ){
						...
						if(!is_edit_model){
							  ...
							  try {
						            ...
						            console.error('historyMsg.vue.pushState failed, maybe HTML5 is not supported?')
						        }
						  }
